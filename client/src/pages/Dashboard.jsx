...
const SpaceDashboard = () => {
  ...
  if (!space) {
    return <LoadingScreen message="Retrieving Space Data..." />;
  }
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              />
                ...
                <div className="p-2">
                  ...
                  <DetailRow icon={Calendar} label="Expires">
                    {new Date(space.expires_at).toLocaleDateString(undefined, {
                      month: 'short',
                      day: 'numeric',
                      hour: '2-digit',
                      minute: '2-digit'
                  ...
                  <DetailRow icon={Shield} label="Security">
                    <span
                      className={`text-[10px] md:text-sm font-bold px-2 py-0.5 rounded ${
                        space.settings.password_protected
                    ...
                    <>
                      ...
                      >
                        <div className="flex w-full justify-between items-center">
                          ...
                          <span className="opacity-70 text-[10px] font-mono ml-1">
                            [{space.extend_count || 0}/3]
                          </span>
                        </div>
                      </Button>
...
const DetailRow = ({ icon: Icon, label, children }) => (
  <div className="flex items-center justify-between p-2.5 md:p-3 hover:bg-slate-50 dark:hover:bg-white/5 rounded-lg transition-colors">
    <div className="flex items-center gap-2 md:gap-3 text-slate-600 dark:text-gray-400">
      <Icon size={16} />
